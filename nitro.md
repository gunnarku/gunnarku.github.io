...
* [AWS Whitepaper: The Security Design of the AWS Nitro System](https://docs.aws.amazon.com/whitepapers/latest/security-design-of-aws-nitro-system/security-design-of-aws-nitro-system.html)
* [Presentation by Kunlin Vansh](https://cseweb.ucsd.edu/~yiying/cse291j-winter20/reading/Nitro.pdf)
...
* [AWS re:Inforce 2019: Security Benefits of the Nitro Architecture (SEP401-R)](https://www.youtube.com/watch?v=kN9XcFp5vUM)
* [AWS re:Invent 2020: Powering next-gen Amazon EC2: Deep dive on the Nitro System](https://www.youtube.com/watch?v=e1_UJTgyFqM)
* [AWS re:Invent 2020: Deep dive on AWS Nitro Enclaves for applications running on Amazon EC2](https://www.youtube.com/watch?v=yDe_C_fpkfg)
